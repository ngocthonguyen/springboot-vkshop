package net.ntn.training.vkshop.business.config;
...
public class CacheConfiguration {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("vkshop");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("vkshop");
        ...
        config.getMapConfigs().put("net.ntn.training.vkshop.business.domain.*", initializeDomainMapConfig(jHipsterProperties));
