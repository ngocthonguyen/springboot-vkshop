...
import net.ntn.training.vkshop.business.service.CategoryService;
import net.ntn.training.vkshop.business.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link net.ntn.training.vkshop.business.domain.Category}.
 */
@RestController
@RequestMapping("/api")
public class CategoryResource {
    ...
    private static final String ENTITY_NAME = "vkshopCategory";
